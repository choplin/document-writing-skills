...
編集上の経験則として使うかは、カタログの役割欄に従う。経験則の目的と検討箇所は
文脈に沿った判断を導くものであり、該当する表現を自動的に欠陥とはしない。

## `ja.argument-recovery`

### 目的

省略された行為者、目的語、補語、情報源、対象、範囲を復元するために、
...
主題が継続、限定、対比、転換のどれに当たるかを読者が判断できない箇所を見つける。
...
復元可能な命題の階層を日本語の構文が平坦化、逆転、または遅延し、
読者に再構成させている箇所を見つける。
...
日本語として関係の表示が足りない箇所、または構文と重複する接続表現で
関係を二重に示した箇所を見つける。
...
一つの局所的な動きを文法だけ再開する日本語の文境界、または一文を
過負荷にする接続を見つける。
